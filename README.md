...
Test is nodejs by typescript
Code quality is more important than time
Avarage test time is 10-20 min, please send test as soon as finished.
Please read ALL Readme till end
...
Compress all necessary files to .zip (not RAR) and send like that, so when we get we can initiate npm and "yarn test"
